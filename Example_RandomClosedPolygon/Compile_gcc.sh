...
g++-14 -Wall -Wextra -Wno-ignored-qualifiers -std=c++20 -m64 -Ofast -flto=auto -fno-math-errno -pthread -mcpu=apple-m1 -mtune=native -DNDEBUG -I.. main.cpp -oExample_RandomClosedPolygon_gcc
